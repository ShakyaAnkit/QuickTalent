<?php include 'header.php' ?>
        ...
        <section class="team-style-three">
            <div class="auto-container">
                ...
                <div class="team-block-one md">
                        <div class="inner-box">
                            <figure class="image-box">
                                <img src="assets/images/team/md.jpeg" alt="">
                                <span class="singature">Om Sai Ram</span>
                                <div class="share-box">
                                    <p><i class="fas fa-share-alt"></i>Share</p>
                                    <ul class="social-links clearfix">
                        ...
                        <div class="second-box"  >
                            <p >To be assertive means that you are confident in whatever you do or say. This is a good word to use because it shows that you are strong-minded and have firm beliefs.<br /><br />
                ...
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box">
                                    <img src="assets/images/team/yog.jpeg" alt="">
                                    <span class="singature">Our Champ</span>
                                    <div class="share-box">
                                        <p><i class="fas fa-share-alt"></i>Share</p>
                                        <ul class="social-links clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box">
                                    <img src="assets/images/team/yash.jpeg" alt="">
                                    <span class="singature">Our Champ</span>
                                    <div class="share-box">
                                        <p><i class="fas fa-share-alt"></i>Share</p>
                                        <ul class="social-links clearfix">
...
<!-- Mirrored from st.ourhtmldemo.com/new/Eazyrecruitz/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Nov 2020 10:25:53 GMT -->
</html>
