                        ...
                        <div class="row clearfix">
                            <div class="col-xl-6 col-lg-12 col-md-12 content-column">
                                <div class="content-box">
                                    <span>Searching  for Quality Leadership?</span>
                                    <h1>Quick Talent  <br />Executive Search <br />finds it for you!</h1>
                                    <p>We bring the right level of expertise to engage our Nation-wide network of top Leadership across multiple domains & industries, to take your Company to that coveted next level!</p>
                                    <div class="btn-box">
                                        <a href="contact.php" class="theme-btn-two">Learn More</a>
                                    </div>
                                </div> 
                            </div>
                        </div> 
                    ...
                    <div class="auto-container">
                        <div class="row clearfix">
                            <div class="col-xl-6 col-lg-12 col-md-12 offset-xl-6 content-column">
                                <div class="content-box">
                                    <span>Looking for The Right Team!</span>
                                    <h1>Allow ‘Quick Talent’ to line them up!</h1>
                                    <p>We, at Quick Talent understand the importance of Right-Fit at the Right-Time for the ‘people intensive projects’ running on strict deadlines.<br/><br/>Give us the permission & we shall  send them to your doorstep!
</p>
                                    <div class="btn-box">
                                        <a href="contact.php" class="theme-btn-two">Learn More</a>
                                    </div>
                    ...
                    <div class="auto-container">
                        <div class="row clearfix">
                            <div class="col-xl-7 col-lg-12 col-md-12 content-column">
                                <div class="content-box">
                                    <span>Hunting your Next Best Hire?</span>
                                    <h1>‘Quick Talent’  <br />tracks them down for you!</h1>
                                    <p>Our Recruiters are well versed with the dynamics of ever changing headhunting process, 
                                        bringing you the best profiles that align with your job descriptions & company values at large! </p>
                                    <div class="btn-box">
                                        <a href="contact.php" class="theme-btn-two">Learn More</a>
                                    </div>
                                </div>  
                                ...
                                <div class="tabs-box">
                                    ...
                                    <div class="tabs-content">
                                        <div class="tab active-tab" id="tab-1">
                                            <div class="inner-box">
                                                <h5>Find Your Next Hire!</h5>
                                                <h2>Quick Talent makes hiring easy !</h2>
                                                <p>We at ‘Quick Talent’ are relatively small yet enthusiastic team of Headhunting professionals dedicated towards finding the best fitting talent for your next requirement! <br /><br />
We are fast in our approach yet reliable in our results! </p>
                                                ...
                                                <div class="link"><a href="place-job.php"><i class="flaticon-right-arrow"></i>Your Required Talent</a></div>
                                            </div>
                                        </div>
                                        <div class="tab" id="tab-2">
                                            <div class="inner-box">
                                                <h5>Find Your Dream Job! </h5>
                                                <h2>Quick Talent finds you the perfect fit!</h2>
                                                <p>Our professional recruiters at Quick Talent offer career consultation along with the real-time opportunities befitting their pursuit!<br /><br />
The long term commitment & loyalty towards our candidates future, is what sets us apart!
</p>
                                                <ul class="list clearfix">
                                                    <li>
                                                ...
                                                <div class="link"><a href="apply-now.php"><i class="flaticon-right-arrow"></i>Your Dream Job</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="about-section">
            <div class="pattern-layer" style="background-image: url(assets/images/shape/pattern-5.png);"></div>
            <div class="auto-container">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                            <div id="content_block_3">
                                <div class="content-box">
                                    <div class="sec-title">
                                        <span class="top-title">About Quick Talent!</span>
                                        <h2>Faster Talent Acquisition Company!</h2>
                                    </div>
                                    <div class="text">
                                        <p>We are a team of highly energetic professionals who aspire to deliver the results like clockwork in this crisis driven industry!<br /><br />
 
 As the name suggests, our goal is to be the fastest talent delivering company in the country keeping the results reliable & quality remarkable!
 </p>
                                    </div>
                                    <div class="link"><a href="contact.php"><i class="flaticon-right-arrow"></i>Connect With Us</a></div>
        ...
        <section class="service-section">
            ...
            <div class="auto-container">
                <div class="sec-title centred">
                    ...
                    <h2>Faster Talent Acquisition Company! </h2>
                    <p>We seek to understand the human resources requirement of your current opening, project, <br />domain in the context of your Company culture & values, so as to provide the right talent in just the nick of time!
</p>
                </div>
                    ...
                    <div class="service-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <div class="overlay-content">
                                    <p>Permanent or long-term positions with salaries, paid time off and benefits like retirement accounts.</p>
                    ...
                    <div class="service-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <div class="overlay-content">
                                    <p>A written or spoken agreement that is intended to be enforceable by law.</p>
                    ...
                    <div class="service-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="content-box">
                                    <div class="inner">
                                        <figure class="icon-box"><img src="assets/images/icons/icon-63.png" alt=""></figure>
                                        <h4>Executive Search</h4>
                                    </div>
                                   
                                </div>
                                <div class="overlay-content">
                                    <p>Seek out and recruit highly qualified candidates for senior-level and executive jobs across the public and private sectors</p>
                    ...
                    <div class="service-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="content-box">
                                    <div class="inner">
                                        <figure class="icon-box"><img src="assets/images/icons/icon-61.png" alt=""></figure>
                                        <h4>Payrolling</h4>
                                    </div>
                                    
                                </div>
                                <div class="overlay-content">
                                    <p>Payrolling is for the contingent workforce, which means you payroll temporary employees.</p>
                    ...
                    <div class="service-block-one">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                <div class="content-box">
                                    <div class="inner">
                                        <figure class="icon-box"><img src="assets/images/icons/icon-62.png" alt=""></figure>
                                        <h4>Training</h4>
                                    </div>
                                    
                                </div>
                                <div class="overlay-content">
                                    <p>The workers can learn the skills that are required to be performed in the actual work conditions</p>
                                ...
                                <div class="inner-box">
                                    <div class="single-item wow fadeInRight animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                        <div class="inner">
                                            ...
                                            <h3><span>01</span><a href="index.php">Sourcing the Best<i class="flaticon-right-arrow"></i></a></h3>
                                    ...
                                    <div class="single-item wow fadeInRight animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                                        <div class="inner">
                                            ...
                                            <h3><span>02</span><a href="index.php">Volume Hiring<i class="flaticon-right-arrow"></i></a></h3>
                                    ...
                                    <div class="single-item wow fadeInRight animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                                        <div class="inner">
                                            ...
                                            <h3><span>03</span><a href="index.php">Partners in Team Building<i class="flaticon-right-arrow"></i></a></h3>
                        ...
                        <div class="col-xl-8 col-lg-12 col-sm-12 content-column">
                            <div class="tabs-content">
                                <div class="tab active-tab" id="tab-3">
                                    <div class="inner-box">
                                        <figure class="image-box"><img src="assets/images/resource/industries-1.jpg" alt=""></figure>
                                        <div class="content-box">
                                            <div class="text">
                                            ...
                                            <div class="line"></div>
                                            <div class="link"><a href="index.php"><i class="flaticon-right-arrow-angle"></i></a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab" id="tab-4">
                                    <div class="inner-box">
                                        <figure class="image-box"><img src="assets/images/resource/industries-2.jpg" alt=""></figure>
                                        <div class="content-box">
                                            <div class="text">
                                                <h2>Hospitality</h2>
                                                <span>26 Jobs in 10 Different Companies</span>
                                ...
                                <div class="tab" id="tab-5">
                                    <div class="inner-box">
                                        <figure class="image-box"><img src="assets/images/resource/industries-3.jpg" alt=""></figure>
                                        <div class="content-box">
                                            <div class="text">
                                                <h2>Manufacturing</h2>
                                                <span>26 Jobs in 10 Different Companies</span>
                                ...
                                <div class="tab" id="tab-6">
                                    <div class="inner-box">
                                        <figure class="image-box"><img src="assets/images/resource/industries-4.jpg" alt=""></figure>
                                        <div class="content-box">
                                            <div class="text">
                                ...
                                <div class="tab" id="tab-7">
                                    <div class="inner-box">
                                        <figure class="image-box"><img src="assets/images/resource/industries-5.jpg" alt=""></figure>
                                        <div class="content-box">
                                            <div class="text">
                                                <h2>Software/IT</h2>
                                                <span>26 Jobs in 10 Different Companies</span>
                                ...
                                <div class="tab" id="tab-8">
                                    <div class="inner-box">
                                        <figure class="image-box"><img src="assets/images/resource/industries-6.jpg" alt=""></figure>
                                        <div class="content-box">
                                            <div class="text">
        ...
        <section class="process-section centred">
            <div class="auto-container">
                <div class="sec-title">
                    ...
                    <h2>3 Steps of ‘Quick Talent’ process</h2>
                    <p>We have honed our craft over the years in the Industry, boiling down our process <br />into a 3 step procedure of getting things done in the swiftest way possible!  </p>
                </div>
                <div class="row clearfix">
                        ...
                        <div class="process-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <p>We seek to the personnel requirement for the particular job profile within the context of project/domain with special attention to the Company culture.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 process-block">
                        <div class="process-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3>Screen the Potential Candidates</h3>
                                    <p>The vast network of candidates allows us to handpick the potentially suitable profiles for your company. After some consultation & rigorous discussion we screen the fit from unfit!.</p>
                                    <a href="contact.php">Visit Us</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 process-block">
                        <div class="process-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3>Selecting the Right Talent</h3>
                                    <p>After screening down the profiles to the right fit, we line them up for interviews. Once you find your desired Talent we take care of the employment contract & other legal obligations!<br /></p>
                                    <a href="contact.php">Visit Us</a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="lower-content">
                                    <div class="inner">
                                        ...
                                        <ul class="post-info clearfix">
                                            <li><i class="far fa-user"></i><a href="index.php">Harley Reuban</a></li>
                                            <li><i class="far fa-comment"></i><a href="index.php">3 Cmnts</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="inner">
                                        ...
                                        <ul class="post-info clearfix">
                                            <li><i class="far fa-user"></i><a href="index.php">Harley Reuban</a></li>
                                            <li><i class="far fa-comment"></i><a href="index.php">5 Cmnts</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="inner">
                                        ...
                                        <ul class="post-info clearfix">
                                            <li><i class="far fa-user"></i><a href="index.php">Harley Reuban</a></li>
                                            <li><i class="far fa-comment"></i><a href="index.php">4 Cmnts</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
...
<!-- Mirrored from st.ourhtmldemo.com/new/Eazyrecruitz/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Nov 2020 10:20:55 GMT -->
</html>
