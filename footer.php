...
<footer class="main-footer bg-color-1">
            ...
            <div class="auto-container">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 footer-column">
                                <div class="footer-widget links-widget">
                                    ...
                                    <ul class="links-list clearfix">
                                        ...
                                        <li><a href="place-job.php">Employers</a></li>
                                        
                                        <li><a href="apply-now.php">Job Seekers</a></li>
                                ...
                                <div class="footer-widget contact-widget">
                                    <div class="single-info-box">
                                        ...
                                        <ul class="info-box clearfix">
                                            <li><a href="tel:9740575254">(+91) 974-057-5254</a></li>
                ...
                <div class="footer-bottom clearfix">
                    <div class="copyright pull-left"><p>&copy; 2020 <a href="index.php">QuickTalent</a>, All Rights Reserved.</p></div>
                    <ul class="footer-nav pull-right clearfix">
                        <li><a href="www.thinkatronics.com">Powered By Thinkatronics</a></li>
